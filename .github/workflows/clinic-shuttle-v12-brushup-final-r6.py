...
OFFICIAL_BASELINE="c7c5ff916986583d6705f032821e690347e95a25"
...
def b3(browser):
    ...
    pdfs={
      ...
      "quick":decode_pdf(QUICK_PDF,3,[DEMO_URL,GUIDE_URL,CHECK_URL,LINE_URL],False),
      "detailed":decode_pdf(DETAIL_PDF,9,[DEMO_URL,MEMBER_URL,OWNER_URL,IPAD_URL,STAFF_URL,CHECK_URL,GUIDE_URL,PRODUCT_URL,LINE_URL],False)
    }
...
def b4():
    ...
    result={
      ...
      "closed_release_defects":["DEF-016","DEF-017","DEF-018","DEF-019","DEF-020","DEF-021","DEF-022"],
...
def main():
    ...
    print("V12_BRUSHUP_R4_SUMMARY="+json.dumps({
      ...
      "CLOSED_RELEASE_DEFECTS":["DEF-016","DEF-017","DEF-018","DEF-019","DEF-020","DEF-021","DEF-022"],"OPEN_BLOCKER":0,"OPEN_HIGH":0,"HUMAN_ACCEPTANCE":"PENDING",
