...
CONTROL_HEAD="548f04a0be5935ecd2f83c041d90fe7e089b65ec"
...
def publicqa():
    ...
    # Guard current external heads after OFFICIAL sweep.
    for repo,expected,label in [
      ...
      ("dpromstk2000-lab/dpro-shop-control-center",CONTROL_HEAD,"CONTROL_CENTER")
    ]:
    ...
    print("V12_OFFICIAL_COUNT_SWEEP_R2C_SUMMARY="+json.dumps({
      ...
      "control_center_head":CONTROL_HEAD
    },ensure_ascii=False))
